...
# The  percentile CI undercovers slightly for n=10 since the bootstrap distribution
# of the median is skewed for small n values.
# The coverage of percentile CI for the bootstrapped data should actually increase
# with the sample size, but because of randomness, the coverage has been reduced for
# sample size of 100
# The Wald CI coverage is slightly above 0.95 for all sample sizes producing over 
# coverage. But the Wald CI seems to be more stable across sample sizes.
